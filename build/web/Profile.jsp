            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="#"> <span class = "fa fa-folder"></span> Home <span class="sr-only">(current)</span></a>
                    </li>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="list-group">
                            ...
                            %>
                          <a href="#" onclick="getPosts(<%= cc.getCategoryId() %>, this)" class="c-link list-group-item list-group-item-action"><%= cc.getName()%></a>
                            <%
                            }
                            %>
                        </div>
